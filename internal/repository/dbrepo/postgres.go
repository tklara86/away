...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	...
	stmt := `INSERT INTO reservations (first_name,
										last_name,
										email,
										phone,
										start_date,	
	...
	err := m.DB.QueryRowContext(ctx, stmt, res.FirstName, res.LastName, res.Email, res.Phone,
		res.StartDate,
		res.EndDate, res.RoomID,time.Now(),time.Now()).Scan(&newId)
...
restriction_id, created_at, updated_at) VALUES ($1,$2,$3,$4,$5,$6,$7)`
	...
	_, err := m.DB.ExecContext(ctx,stmt, r.StartDate, r.EndDate, r.RoomID, r.ReservationID,
